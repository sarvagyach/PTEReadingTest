 ...
 */
public class WFITBTestResultFragment extends Fragment {

    TextView textViewScore, textViewMainScore;
    MaterialButton btnReturnToMenu;


    public WFITBTestResultFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_wfitbtest_result, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        float score = WFITBTestResultFragmentArgs.fromBundle(getArguments()).getScore();
        ...
        btnReturnToMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavDirections action = WFITBTestResultFragmentDirections.actionWFITBTestResultFragmentToStartFragment();
