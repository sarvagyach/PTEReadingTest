 ...
 */
public class RPTestResultFragment extends Fragment {

    TextView textViewScore, textViewMainScore;
    MaterialButton btnReturnToMenu;

    public RPTestResultFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_rptest_result, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        float score = RPTestResultFragmentArgs.fromBundle(getArguments()).getScore();
        ...
        btnReturnToMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavDirections action = RPTestResultFragmentDirections.actionRPTestResultFragmentToStartFragment();
